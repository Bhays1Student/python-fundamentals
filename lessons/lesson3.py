...
# if you put in a value of the index that is higher than the number
...
# This technique is the ability to compare a set of characters with a
# string variable.  This result will either be True or False. We use in or
# not in keywords for check string
...
name = 'John'
total = 34.9856
msg3 = 'Hello {0}, your order comes to {1:5.2f}'
