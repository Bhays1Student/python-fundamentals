# All about numbers
# Numeric types are broken down into 3 distinct categories: int,
# float and complex
...
# The method below will convert an integer to different numeric system values
print(bin(22))
print(oct(22))
print(hex(22))
...
# Taking values that are strings and converting, while also
